...
- Introduction to Ansible structure:
  - Playbook
  - Play
  - Modules
  - Tasks
...
- Why Policy as Code matters in infrastructure automation
- Common use cases in DevOps and cloud governance

### Day 11: Network Automation using Ansible
- Introduction to network automation
- Managing network devices with Ansible
- Common modules and use cases for network operations
...
- Best practices and real-world discussions
...
- Tower
- Network automation
- Real-world project integration with Terraform
